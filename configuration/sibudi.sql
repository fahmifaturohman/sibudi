...
(1, 'SIBUDI', 'Sistem Informasi Buku Tamu Digital', 'Instansi', '085789871372', 'Jl Kemayoran timur gang 1');
...
--
ALTER TABLE `survey`
  MODIFY `id_survey` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
